...
my_account = Account(number="123456", pin=1234)
print(my_account.view_account_details(1234))
print(my_account.deposit(30000))
print(my_account.withdraw(5000))
print(my_account.change_account_owner("Patricia Ainembabazi",1234 ))
print(my_account.account_statement(1234))
print(my_account.set_overdraft_limit(200000, 1234))
print(my_account.calculate_interest( 3, 1234))
print(my_account.freeze_account(1234))
print(my_account.unfreeze_account(1234))
print(my_account.transaction_history(1234))
print(my_account.set_minimum_balance( 6000, 1234))
print(my_account.transfer_funds(40000, 789012, 1234))
print(my_account.close_account(1234))
